...
$searchkey=strtolower(preg_replace("#[^0-9a-z]#i", "",strip_tags($_POST['search'])));//this searches if the user use 123book in search it removes book in search.
$row=$showobj->search($searchkey);
}
?>
<!DOCTYPE html>
<html lang="en">
